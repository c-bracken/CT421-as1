...
# New population with elite individuals
...
# Generates new populations until a solution is found
for i in range(population):
    bitstr = ""
...
# Prints information about each generation
while True:
    ...
    if champ[1] == length:
        print("FREAK FOUND: INDEX {}, FREAK CODE {}".format(champ[0], popList[champ[0]]))
        break
    else:
        print("NOT DONE")
